...
module.exports = async function (context, req,err,callback) {
 if(err){
  ...
  console.log('JavaScript HTTP trigger function processed a request.');
    ...
    console.log("Closing IoT Hub connection");
   
    const { promises : fs} = require('fs')
    let file1 = await fs.readFile(__dirname + "/TemperatureRedirecting.html", 'UTF-8');
